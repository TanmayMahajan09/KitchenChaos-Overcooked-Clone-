...
public class SoundManager : MonoBehaviour {
    ...
    private void Start () {
        ...
        Player.Instance.OnSomethingPicked += Player_OnSomethingPicked;
    ...
    private void BaseCounter_OnAnythingPlacedHere(object sender, System.EventArgs e) {
        BaseCounter baseCounter = sender as BaseCounter;
        PlaySound(audioClipRefsSO.objectDrop, baseCounter.transform.position);
    }

    private void Player_OnSomethingPicked(object sender, System.EventArgs e) {
