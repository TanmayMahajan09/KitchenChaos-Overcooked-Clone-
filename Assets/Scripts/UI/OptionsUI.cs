...
public class OptionsUI : MonoBehaviour {
    ...
    private void UpdateVisual() {
        ...
        interactAlternateText.text = GameInput.Instance.GetBinding(GameInput.Binding.InteractAlternate);
        pauseText.text = GameInput.Instance.GetBinding(GameInput.Binding.Pause);
        gamepadInteractText.text = GameInput.Instance.GetBinding(GameInput.Binding.Gamepad_Interact);
        gamepadInteractAlternateText.text = GameInput.Instance.GetBinding(GameInput.Binding.Gamepad_InteractAlternate);
        gamepadPauseText.text = GameInput.Instance.GetBinding(GameInput.Binding.Gamepad_Pause);
    }
